...
//  interest
//
//  Created by Mohamed AbouElkhair on 3/18/20.
...
class Login {
    ...
    func postRequest(name: String,
        ...
        let parameters = ["name": name,"email":email,"password":password,"idUser":idUser,"typeLogin":typeLogin,"photoLink":photoLink ]
...
//        postRequest(name: "username") { (result, error) in
